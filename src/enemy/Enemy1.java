...
public class Enemy1 extends Monster{
	...
	public Enemy1() {
		...
		spriteYCoordinates[Constant.RIGHT] = new int[] {0, 0, 0};
		spriteXCoordinates[Constant.LEFT] = new int[] {0, 48, 96};
		spriteYCoordinates[Constant.LEFT] = new int[] {48, 48, 48};
		spriteXCoordinates[Constant.UP] = new int[] {0, 48, 96};
		spriteYCoordinates[Constant.UP] = new int[] {0, 0, 0};
		spriteXCoordinates[Constant.DOWN] = new int[] {0, 48, 96}; 
		spriteYCoordinates[Constant.DOWN] = new int[] {48, 48, 48};
